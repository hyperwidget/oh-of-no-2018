...
var _default = {
  ...
  b: inputs => {
    ...
    const keys = Object.keys(steps).sort();
    startingPoints = (0, _lodash.difference)(Object.keys(steps), targets).sort(); // steps[startingPoint].processed = true
    ...
    while (path.length < keys.length) {
      ...
      canBeProcessed = (0, _lodash.difference)(canBeProcessed, inProcess).sort(); // if worker is available then process
